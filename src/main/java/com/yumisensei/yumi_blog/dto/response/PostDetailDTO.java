...
public class PostDetailDTO {
    ...
    public PostDetailDTO(UUID id, String title, String slug, String excerpt, String content,
                         String featuredImage, Boolean featuredPost, LocalDateTime createdAt,
                         AuthorDTO author, List<CategoryDTO> categories) {
        this.id = id;
        this.title = title;
        this.slug = slug;
